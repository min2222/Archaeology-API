...
public class MixinOceanRuinPiece implements IOceanRuinPiece
{
	...
	public StructurePlaceSettings getPlaceSetting() 
	{
		...
		return (new StructurePlaceSettings()).setRotation(Rotation.getRandom(RandomSource.create())).setMirror(Mirror.NONE).addProcessor(BlockIgnoreProcessor.STRUCTURE_AND_AIR).addProcessor(structureprocessor);
	}
}
